...
const Layout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: "Members", href: "/members", icon: "👥", roles: ["System Manager", "Librarian"] },
    { name: "Loans", href: "/loans", icon: "📖", roles: ["System Manager", "Librarian"] },
    { name: "Reservations", href: "/reservations", icon: "📋" },
    { name: "Reports", href: "/reports", icon: "📈", roles: ["System Manager", "Librarian"] },
  ]
